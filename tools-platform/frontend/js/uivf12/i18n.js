...
(function () {
    const dictionaries = {
        'zh-CN': {
            ...
            'uiv.alert.emptyExport': '⚠️ 当前仓库为空，没有需要导出的配置！',
            'uiv.export.filename': 'UIVision_抓取引擎配置备份_{date}.json',
            'uiv.toast.exported': '✅ 仓库备份配置已安全导出！',
            'uiv.toast.exportFail': '❌ 导出失败',
            'uiv.alert.invalidBackup': '❌ 无效备份文件格式',
            'uiv.confirm.importMode': '📦 成功解析备份文件！\n\n点击【确定】融合（保留现有脚本，追加新脚本）\n点击【取消】覆盖（清空现有仓库，完全替换）',
            'uiv.toast.imported': '✅ 配置快照已成功导入！',
            'uiv.alert.importFail': '❌ 导入失败：解析文件出错。',
        ...
        'en-US': {
            ...
            'uiv.alert.emptyExport': '⚠️ The repository is empty; there is nothing to export.',
            'uiv.export.filename': 'UIVision_Capture_Engine_Backup_{date}.json',
            'uiv.toast.exported': '✅ Repository backup exported safely!',
            'uiv.toast.exportFail': '❌ Export failed',
            'uiv.alert.invalidBackup': '❌ Invalid backup file format',
            'uiv.confirm.importMode': '📦 Backup file parsed successfully!\n\nOK: merge with existing scripts\nCancel: overwrite the current repository',
            'uiv.toast.imported': '✅ Configuration snapshot imported!',
            'uiv.alert.importFail': '❌ Import failed: file parsing error.',
