...
(function () {
    const dictionaries = {
        'zh-CN': {
            ...
            'sla.rule.open': 'Risk Open / Risk Suspended / Complete Reviewing：按 ticket_close_due_date 倒计时，剩余 ≤10 天红，<30 天紫',
            'sla.rule.suspended': '兼容逻辑：ticket_close_due_date 为空时，再尝试 due_time / 期望关闭时间-挂起 / suspend_due_date',
        ...
        'en-US': {
            ...
            'sla.rule.open': 'Risk Open / Risk Suspended / Complete Reviewing: countdown by ticket_close_due_date; red when ≤10 days left, purple when <30',
            'sla.rule.suspended': 'Compatibility fallback: when ticket_close_due_date is empty, try due_time / suspended expected close time / suspend_due_date',
